...
st.markdown(
    """
Este painel automatiza a análise de dados do OpenDATASUS para apoio à tomada de decisão na
    ...
    with g2:
        ...
        if not waste_df.empty:
            fig_waste = px.bar(
                ...
                labels={
                    "severity_index": "Índice de Gravidade",
