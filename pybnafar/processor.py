...
from .schema import COLUMN_ALIASES, EXPECTED_SCHEMA, detect_data_drift
from .utils import calculate_hash, logger
...
class BnafarProcessor:
    ...
    def process_and_partition(
        cls, csv_path: str, output_dir: str, manifest_dir: str, metadata: dict
    ):
        """
        ...
        try:
            ...
            manifest_path = os.path.join(
                manifest_dir,
                f"manifest_{metadata['snapshot'].replace(' ', '_')}.json",
            )
